  ...
  return (
    <div className="bg-[#e3f6f5] py-12 px-4">
      <div className="max-w-5xl mx-auto text-center">
        <h2 data-aos="fade-up" className="text-3xl md:text-4xl font-bold mt-2 mb-8 text-[#272343]">
          Why Choose Us
        </h2>
        <div data-aos="fade-right" className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
          <ChooceComponent
            number="1"
